...
<tr><td><a href="https://github.com/fmtlib/fmt">fmt</a></td><td>C++</th><td>A modern formatting library</td></tr>
<tr><td><a href="https://github.com/chrislgarry/Apollo-11">Apollo-11</a></td><td>Assembly</th><td>Original Apollo 11 Guidance Computer (AGC) source code for the command and lunar modules.</td></tr>
<tr><td><a href="https://github.com/miyuchina/mistletoe">mistletoe</a></td><td>Python</th><td>A fast, extensible and spec-compliant Markdown parser in pure Python.</td></tr>
<tr><td><a href="https://github.com/malkreide/socratic-method-skill">socratic-method-skill</a></td><td>None</th><td>Die sokratische Methode als Claude Skill.md</td></tr>
<tr><td><a href="https://github.com/janestreet/magic-trace">magic-trace</a></td><td>OCaml</th><td>magic-trace collects and displays high-resolution traces of what a process is doing</td></tr>
<tr><td><a href="https://github.com/ruvnet/RuView">RuView</a></td><td>Rust</th><td>π RuView turns commodity WiFi signals into real-time spatial intelligence, vital sign monitoring, and presence detection — all without a single pixel of video.</td></tr>
<tr><td><a href="https://github.com/bloomberg/goldpinger">goldpinger</a></td><td>JavaScript</th><td>Debugging tool for Kubernetes which tests and displays connectivity between nodes in the cluster.</td></tr>
<tr><td><a href="https://github.com/brave/brave-search-mcp-server">brave-search-mcp-server</a></td><td>TypeScript</th><td>None</td></tr>
<tr><td><a href="https://github.com/pyenv/pyenv">pyenv</a></td><td>Shell</th><td>Simple Python version management</td></tr>
<tr><td><a href="https://github.com/draios/sysdig">sysdig</a></td><td>C++</th><td>Linux system exploration and troubleshooting tool with first class support for containers</td></tr>
<tr><td><a href="https://github.com/brendangregg/perf-tools">perf-tools</a></td><td>Shell</th><td>Performance analysis tools based on Linux perf_events (aka perf) and ftrace</td></tr>
<tr><td><a href="https://github.com/blader/humanizer">humanizer</a></td><td>Python</th><td>Agent skill that removes signs of AI-generated writing from text</td></tr>
<tr><td><a href="https://github.com/jemalloc/jemalloc">jemalloc</a></td><td>C</th><td>None</td></tr>
<tr><td><a href="https://github.com/lightpanda-io/browser">browser</a></td><td>Zig</th><td>Lightpanda: the headless browser designed for AI and automation</td></tr>
<tr><td><a href="https://github.com/p-e-w/heretic">heretic</a></td><td>Python</th><td>Fully automatic censorship removal for language models</td></tr>
<tr><td><a href="https://github.com/lesismal/nbio">nbio</a></td><td>Go</th><td>Pure Go 1000k+ connections solution, support tls/http1.x/websocket and basically compatible with net/http, with high-performance and low memory cost, non-blocking, event-driven, easy-to-use.</td></tr>
<tr><td><a href="https://github.com/lxzan/gws">gws</a></td><td>Go</th><td>simple, fast, reliable websocket server & client, supports running over tcp/kcp/unix domain socket. keywords: ws, proxy, chat, go, golang...</td></tr>
<tr><td><a href="https://github.com/pgvector/pgvector">pgvector</a></td><td>C</th><td>Open-source vector similarity search for Postgres</td></tr>
<tr><td><a href="https://github.com/hadialqattan/pycln">pycln</a></td><td>Python</th><td>A formatter for finding and removing unused import statements.</td></tr>
<tr><td><a href="https://github.com/labmlai/annotated_deep_learning_paper_implementations">annotated_deep_learning_paper_implementations</a></td><td>Python</th><td>🧑‍🏫 60+ Implementations/tutorials of deep learning papers with side-by-side notes 📝; including transformers (original, xl, switch, feedback, vit, ...), optimizers (adam, adabelief, sophia, ...), gans(cyclegan, stylegan2, ...), 🎮 reinforcement learning (ppo, dqn), capsnet, distillation, ... 🧠</td></tr>
<tr><td><a href="https://github.com/mtdvio/every-programmer-should-know">every-programmer-should-know</a></td><td>None</th><td>A collection of (mostly) technical things every software developer should know about</td></tr>
<tr><td><a href="https://github.com/iptv-org/iptv">iptv</a></td><td>TypeScript</th><td>Collection of publicly available IPTV channels from all over the world</td></tr>
<tr><td><a href="https://github.com/matthewwithanm/python-markdownify">python-markdownify</a></td><td>Python</th><td>Convert HTML to Markdown</td></tr>
<tr><td><a href="https://github.com/Engineer1999/A-Curated-List-of-ML-System-Design-Case-Studies">A-Curated-List-of-ML-System-Design-Case-Studies</a></td><td>None</th><td>This repository contains a curated collection of 300+ case studies from over 80 companies, detailing practical applications and insights into machine learning (ML) system design. The contents are organized to help you easily find relevant case studies based on industry or specific ML use cases. </td></tr>
<tr><td><a href="https://github.com/pranshuparmar/witr">witr</a></td><td>Go</th><td>Why is this running? Trace any process, port, container, or file back to what started it - CLI + TUI. </td></tr>
<tr><td><a href="https://github.com/codecrafters-io/build-your-own-x">build-your-own-x</a></td><td>Markdown</th><td>Master programming by recreating your favorite technologies from scratch.</td></tr>
<tr><td><a href="https://github.com/harehare/mq">mq</a></td><td>Rust</th><td>A jq-like Markdown query language for command-line processing</td></tr>
<tr><td><a href="https://github.com/psycopg/psycopg2">psycopg2</a></td><td>C</th><td>PostgreSQL database adapter for the Python programming language</td></tr>
<tr><td><a href="https://github.com/xlwings/xlwings">xlwings</a></td><td>Python</th><td>xlwings is a Python library that makes it easy to call Python from Excel and vice versa. It works with Excel on Windows, macOS, and Excel on the web. </td></tr>
<tr><td><a href="https://github.com/psycopg/psycopg">psycopg</a></td><td>Python</th><td>New generation PostgreSQL database adapter for the Python programming language </td></tr>
<tr><td><a href="https://github.com/karpathy/llm-council">llm-council</a></td><td>Python</th><td>LLM Council works together to answer your hardest questions</td></tr>
<tr><td><a href="https://github.com/tobymao/sqlglot">sqlglot</a></td><td>Python</th><td>Python SQL Parser and Transpiler</td></tr>
<tr><td><a href="https://github.com/P3GLEG/Whaler">Whaler</a></td><td>Go</th><td>Program to reverse Docker images into Dockerfiles</td></tr>
<tr><td><a href="https://github.com/paperswithbacktest/awesome-systematic-trading">awesome-systematic-trading</a></td><td>Python</th><td>A curated list of awesome libraries, packages, strategies, books, blogs, tutorials for systematic trading.</td></tr>
<tr><td><a href="https://github.com/ahmetb/kubectx">kubectx</a></td><td>Go</th><td>Faster way to switch between clusters and namespaces in kubectl</td></tr>
<tr><td><a href="https://github.com/imputnet/helium">helium</a></td><td>C++</th><td>Private, fast, and honest web browser</td></tr>
<tr><td><a href="https://github.com/davidesantangelo/fastrace">fastrace</a></td><td>C</th><td>A fast, dependency-free traceroute implementation in pure C.</td></tr>
<tr><td><a href="https://github.com/chubin/wttr.in">wttr.in</a></td><td>Go</th><td>:partly_sunny: The right way to check the weather</td></tr>
<tr><td><a href="https://github.com/dinoDanic/diny">diny</a></td><td>Go</th><td>Free AI git commit messages. No API key. No signup</td></tr>
<tr><td><a href="https://github.com/drakkan/sftpgo">sftpgo</a></td><td>Go</th><td>Full-featured and highly configurable SFTP, HTTP/S, FTP/S and WebDAV server - S3, Google Cloud Storage, Azure Blob</td></tr>
...
<tr><td><a href="https://github.com/binpash/try">try</a></td><td>Shell</th><td>Inspect, control, and manipulate a command's effects before modifying your live system.</td></tr>
...
<tr><td><a href="https://github.com/zylon-ai/private-gpt">private-gpt</a></td><td>Python</th><td>Complete API layer for private AI applications on local models: RAG, skills, tools, MCP, text-to-sql, and more. Works with any OpenAI-compatible inference server.</td></tr>
<tr><td><a href="https://github.com/EbookFoundation/free-programming-books">free-programming-books</a></td><td>Python</th><td>:books: Freely available programming books</td></tr>
<tr><td><a href="https://github.com/twitter/the-algorithm">the-algorithm</a></td><td>Scala</th><td>Source code for the X Recommendation Algorithm</td></tr>
...
<tr><td><a href="https://github.com/mehdihadeli/awesome-software-architecture">awesome-software-architecture</a></td><td>TypeScript</th><td>📚 A curated list of awesome articles, videos, and other resources to learn and practice software architecture, patterns, and principles.</td></tr>
...
<tr><td><a href="https://github.com/zesterer/chumsky">chumsky</a></td><td>Rust</th><td>[Chumsky has moved to Codeberg!] Write expressive, high-performance parsers with ease.</td></tr>
...
<tr><td><a href="https://github.com/ossu/computer-science">computer-science</a></td><td>HTML</th><td>🎓 Path to a free self-taught education in Computer Science!</td></tr>
...
<tr><td><a href="https://github.com/monoio-rs/monoio">monoio</a></td><td>Rust</th><td>Rust async runtime based on io-uring.</td></tr>
...
<tr><td><a href="https://github.com/rui314/mold">mold</a></td><td>Rust</th><td>mold 🦠: A Modern Linker in Rust 🦀</td></tr>
